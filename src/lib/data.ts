...
export const initialOrders: Order[] = [
  {
    id: 'ord1',
    items: [
      { productId: 'prod1', name: 'Hamburguesa Clásica', price: 8.99, quantity: 1, image: 'https://placehold.co/300x300.png' },
      { productId: 'prod3', name: 'Patatas Fritas', price: 3.49, quantity: 1, image: 'https://placehold.co/300x300.png' },
  ...
  },
  {
    id: 'ord2',
    items: [
      { productId: 'prod2', name: 'Doble Cheeseburger', price: 11.99, quantity: 2, image: 'https://placehold.co/300x300.png' },
    ],
    total: 23.98,
  ...
  },
  {
    id: 'ord3',
    items: [
      { productId: 'prod5', name: 'Hamburguesa Vegetariana', price: 9.99, quantity: 1, image: 'https://placehold.co/300x300.png' },
      { productId: 'prod6', name: 'Aros de Cebolla', price: 4.49, quantity: 1, image: 'https://placehold.co/300x300.png' },
    ],
    total: 14.48,
    ...
    id: 'ord4',
    items: [
      { productId: 'prod1', name: 'Hamburguesa Clásica', price: 8.99, quantity: 2, image: 'https://placehold.co/300x300.png' },
    ],
    total: 17.98,
